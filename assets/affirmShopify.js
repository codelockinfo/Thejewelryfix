...
<!-- Affirm -->
	...
	let parsedRegionPublicKeys = JSON.parse('{"US":"YXXM9EFYI2JW1HCA","CA":null}');

	if (_shopify_country === 'US') {
		_affirm_country = 'USA';
		_affirm_locale = 'en_US';
		_region_public_key = 'YXXM9EFYI2JW1HCA'
...
let promosJSON = '[{"promoStatus":false,"pageType":"product","selector":null,"onChange":null,"fontSize":"12","logoType":"logo","logoColor":"blue","position":"afterend","addCents":false,"saleSelector":null,"comparePrices":false,"dataElement":null,"alaElement":null,"shopifyPageType":"product"}]';
